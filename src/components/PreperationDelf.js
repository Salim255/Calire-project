    ...
    <div>
      <section className='section-cours-description'>
        ...
        <div className='center-text margin-bottom-big'>
          <h2 className='heading--secendary'>Préparation DELF / DALF</h2>
        ...
        <div className='cours-description '>
          <div>
            ...
            Cours de préparation complète: méthodologie et entrainement aux
            examens DELF/DALF, A1, A2, B1, B2, C1 et C2.
...
export default PreperationDelf
